...
if __name__ == "__main__":
	...
	print("size startE en vecteur: ", startE.shape)
	deltaT = 5e-5
	finalT = 0.1
	
	# computing 
	res = EulerImplMaxwell1D(V, W, startE, startB,  deltaT, finalT, epsilon0, mu0,  t=0., savefig=True, dirichlet=True)
...
#	print(res.bfield())
	...
	plt.legend()
	plt.title('Euler Implicit Scheme Electric field\ndt='+str(deltaT)+' t='+str(finalT))
	plt.show()
