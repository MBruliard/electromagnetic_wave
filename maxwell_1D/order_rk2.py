...
if __name__ == "__main__":
	...
	for dt in deltaT:
		...
		rktwo = SchemeRKtwo1D(V, W, startE, startB,  dt, final_time, epsilon0, mu0, dirichlet=True)
		rktwoe = rktwo.efield()
		rktwob = rktwo.bfield()
		...
		quad_values_E = quad_values_from_vector(V, rktwoe)
...
#	plt.plot(deltaT, order3, label='order 3', color='c')
	...
	plt.legend()
	plt.title('Error curve of electrical field with RK2\nB-Splines degree: '+str(degree))
