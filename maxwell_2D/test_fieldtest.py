...
if __name__ == "__main__":
	...
	startB = Field1d(twoToOneD(valB))
	startE = Field2d(twoToOneD(valEx), twoToOneD(valEy))
#	
#	print('startB:\n ', startB.dir())
#	
#	print('test tovectorColumn from field1D:\n', startB.tovectorColumn())
#	print('test tovectorColumn from field2D:\n', startE.tovectorColumn())
